...
FriendlyChat.prototype.loadMessages = function() {
  // done: Load and listens for new messages.
...
FriendlyChat.prototype.saveMessage = function(e) {
  ...
  if (this.messageInput.value && this.checkSignedInWithMessage()) {
    ...
    this.messagesRef.push({
        ...
        photoUrl: currentUser.photoURL || '/imagess/profile_placeholder.png'
    }).then(function () {
...
FriendlyChat.prototype.onAuthStateChanged = function(user) {
  if (user) { // User is signed in!
    ...
    var profilePicUrl = user.photoURL;   // done Get profile pic.
    var userName = user.displayName;        // done Get user's name.
...
FriendlyChat.prototype.checkSignedInWithMessage = function() {
  /* done Check if user is signed-in Firebase. */
